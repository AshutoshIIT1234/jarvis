...
You can also manage your emails through the voice assistant:
...
1. Delete the token file at `~/.credentials/calendar_token.json` or `~/.credentials/gmail_token.json`
...
### Email Permission Issues

If you need additional email permissions:

1. Delete the token file at `~/.credentials/gmail_token.json`
2. Edit the `SCOPES` variable in `app/jarvis/tools/email_utils.py`
3. Run the setup script again
