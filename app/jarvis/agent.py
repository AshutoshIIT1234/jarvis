...
root_agent = Agent(
    ...
    helping with scheduling, calendar operations, and email management.
    ...
    ## Email operations
    You can perform email operations directly using these tools:
    - `list_emails`: Show emails from your inbox or other labels
